...
write_csv(alive_cells_unrestricted, "../eden/simulation_data/alive_cells_pushing_pop_1000_dr_0.10.csv")
write_csv(alive_cells_boundary_driven, "../eden/simulation_data/alive_cells_death_rate_validation_pop_1000_dr_0.10.csv")
...
### To save as RDS
saveRDS(tree_boundary_driven_pruned, file = "../eden/simtrees/boundary_driven_timetree.rds")
saveRDS(tree_molecular_boundary_driven_pruned, file = "../eden/simtrees/boundary_driven_moleculartree.rds")

saveRDS(tree_unrestricted_pruned, file = "../eden/simtrees/unrestricted_timetree.rds")
saveRDS(tree_molecular_unrestricted_pruned, file = "../eden/simtrees/unrestricted_moleculartree.rds")
# 
# tree_boundary_driven <- readRDS(file = "../eden/simtrees/boundary_driven_timetree.rds")
# tree_molecular_boundary_driven <- readRDS(file = "../eden/simtrees/boundary_driven_moleculartree.rds")
# 
...
ggsave(file = "tumor_sim_growth_rate_boundary_driven_void.png",
       plot = a_void , path = figures_dir, height = 4, width = 2)
...
ggsave(file = "time_tree_growth_rate_boundary_driven.png", plot = b, path = figures_dir, height = 6, width = 5)
ggsave(file = "time_tree_growth_rate_boundary_driven_unlabeled.png", plot = b_unlabeled, path = figures_dir, height = 6, width = 5)
...
ggsave(file = "molecular_tree_growth_rate_boundary_driven.png", plot = c, path = figures_dir, height = 6, width = 5)
ggsave(file = "molecular_tree_growth_rate_boundary_driven_unlabeled.png", plot = c_unlabelled, path = figures_dir, height = 6, width = 5)
...
ggsave(file = "tumor_sim_growth_rate_unrestricted_unlabeled.png", plot = a, path = figures_dir, height = 4, width = 5)
...
ggsave(file = "molecular_tree_growth_rate_unrestricted.png", plot = c, path = figures_dir, height = 6, width = 5)
ggsave(file = "molecular_tree_growth_rate_unrestricted_unlabeled.png", plot = c_unlabeled, path = figures_dir, height = 6, width = 5)

...
template_file <- "../physicell/state-clocks-template.xml"
...
## 2D Neutral
data_files_2D_neut_bdg_diversified <- list.files(path = "../physicell/simulated_data/2D_neut_bdg/diversified_100/to_beast_format_corrected_hulls",
                                                        pattern="sampconfig.*",
                                                 full.names = TRUE)

edge_center_proportions_2D_neut_bdg_file <- "../physicell/simulated_data/2D_neut_bdg/edge_v_center_counts_2D_neut_bdg.tsv"
...
## 2D selection w/ selection

data_files_2D_sel_diversified <- list.files(path = "../physicell/simulated_data/2D_sel_highermu/diversified_100/to_beast_format_corrected_hulls",
                                                       pattern="sampconfig.*", full.names = TRUE)


edge_center_proportions_2D_sel_df <-read_tsv("../physicell/simulated_data/2D_sel_highermu/edge_v_center_counts_2D_sel_highermu.tsv")
...
## 2D selection with boundary-driven grwoth

data_files_2D_sel_bdg_diversified <-  list.files(path = "/Volumes/BALAENA/projects/spatial_tumor_growth_simulation/outputs/beast_analysis/state_dependent_clock_model/validation/physicell/simulated_data/2D_sel_bdg_highermu/diversified_100/to_beast_format_corrected_hulls",
                                                       pattern="sampconfig.*", full.names = TRUE)
edge_center_proportions_2D_sel_bdg_df <-read_tsv("../physicell/simulated_data/2D_sel_bdg_highermu/edge_v_center_counts_2D_sel_bdg_highermu.tsv")
...
# 3D boundary-driven growth
data_files_3D_neut_bdg_diversified <- list.files(path = "../physicell/simulated_data/3D_neut_bdg/diversified_100/to_beast_format_corrected_hulls",
                                                       pattern="sampconfig.*")

edge_center_proportions_3D_neut_bdg_df <-read_tsv("../physicell/simulated_data/3D_neut_bdg/edge_v_center_counts_3D_neut_bdg.tsv")

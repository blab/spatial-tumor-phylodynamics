...
def cancer_sim(founder_cells = 1,deltat=(1/float(24)),CSC = True,max_cells = 1000,
               ...
               mortality = 0.1, mutation = 1, selection = False,ps = 0.05,
...
def pushing_cancer_sim2(founder_cells = 1,deltat=(1/float(24)),CSC = True,max_cells = 1000,
                   proliferationCSC = 1, proliferationCC = 2, motility = 15, pmax = 10,
                   mortality = 0.1, mutation = 1, selection = False, JC = True):
...
#         proliferationCC = 0.5, CSC = False, pmax = 10,mutation = 1,mortality = dr, JC = True)
#
#         #convert to dataframe
#         CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#         file_name = f"../eden/simulation_data/cells_death_rate_validation_pop_{N}_mu_1_dr_%0.3f.csv" %(dr)
...
#             CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#             file_name = f"../eden/simulation_data/cells_death_rate_validation_pop_{N}_mu_1_dr_%0.2f_i_{i}.csv" %(dr)
#             CC_df.to_csv(file_name)
...
#     CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#     file_name = f"../eden/simulation_data/cells_death_rate_validation_{N}_mu_1_i_{itr}_dr_%0.2f.csv" %(dr)
#     CC_df.to_csv(file_name)
...
#
#     #save locations
#     locs_file_name = f"../eden/simulation_data/cells_pushing_pop2_{N}_mu_1_dr_%0.3f_i_{itr}_locs.csv" %(dr)
#     all_locations_df_CC.to_csv(locs_file_name)
#     #convert to dataframe
#     CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#     file_name = f"../eden/simulation_data/cells_pushing_pop2_{N}_mu_1_dr_%0.3f_i_{itr}.csv" %(dr)
#     CC_df.to_csv(file_name)
#
...
#
#     #save locations
#     locs_file_name = f"../eden/simulation_data/cells_pushing_pop_{N}_mu_1_dr_%0.3f_locs.csv" %(dr)
#     all_locations_df_CC.to_csv(locs_file_name)
#     #convert to dataframe
#
#     #convert to dataframe
#     CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#     file_name = f"../eden/simulation_data/cells_pushing_pop_{N}_mu_1_dr_%0.3f.csv" %(dr)
#     CC_df.to_csv(file_name)
#
...
#
#         #save locations
#         locs_file_name = f"../eden/simulation_data/cells_pushing_pop_{N}_mu_1_dr_%0.3f_i_{i}_locs.csv" %(dr)
#         all_locations_df_CC.to_csv(locs_file_name)
#         #convert to dataframe
#         CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])
#
#         file_name = f"../eden/simulation_data/cells_pushing_pop_{N}_mu_1_dr_%0.3f_i_{i}.csv" %(dr)
#         CC_df.to_csv(file_name)
#
...
for itr in i_list:
    #run simulated
    cells_CC, alive_cells_CC, lattice_CC = pushing_cancer_sim2(founder_cells = 1,max_cells = N, proliferationCSC = 0.5,
    proliferationCC = 0.5, CSC = False, pmax = 10,mutation = 1, mortality = dr, JC = True)

    #convert to dataframe
    CC_df = pd.DataFrame([x.as_dict() for x in cells_CC])

    file_name = f"../eden/simulation_data/cells_pushing_pop_{N}_mu_1_i_{itr}_dr_%0.2f.csv" %(dr)
    CC_df.to_csv(file_name)

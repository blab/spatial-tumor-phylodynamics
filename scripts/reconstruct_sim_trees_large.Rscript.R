...
sim_cells_files <- list.files(path="../../simulation_data",
                                      pattern = "cells_death_rate_validation_pop_10000_dr_[0-9].[0-9]+.csv", include.dirs = TRUE, full.names = TRUE)
...
pushing_sim_cells_files <- list.files(path="../../simulation_data",
                                      pattern = "cells_pushing_pop_10000_dr_[0-9].[0-9]+.csv", include.dirs = TRUE, full.names = TRUE)

pushing_sim_cells_locs_files <- list.files(path="../../simulation_data",
                                           pattern = "cells_pushing_pop_10000_dr_[0-9].[0-9]+_locs.csv", include.dirs = TRUE, full.names = TRUE)

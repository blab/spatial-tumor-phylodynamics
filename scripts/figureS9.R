...
#t1_masked_muts <- as.integer(unlist(c(read_csv(file="~/Documents/PhD/Bedford_lab/spatial-tumor-phylodynamics/li-application/li_hcc_data/t1_masked_sites.txt", col_names = FALSE))))
#t2_masked_muts <- as.integer(unlist(c(read_csv(file="~/Documents/PhD/Bedford_lab/spatial-tumor-phylodynamics/li-application/li_hcc_data/t2_masked_sites.txt", col_names = FALSE))))

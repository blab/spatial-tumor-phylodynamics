...
T1_mcc_tree <- read.beast("../li-application/out/T1_wgs_oristates_unidir_state_comb.HCCtumor_mcc.tree")
T2_mcc_tree <- read.beast("../li-application/out/T2_wgs_oristates_unidir_state_comb.HCCtumor_mcc.tree")

T1_strict_clock_mcc_tree <- read.beast("../li-application/out/T1_wgs_oristates_unidir_strict_comb.HCCtumor_mcc.tree")
T2_strict_clock_mcc_tree <- read.beast("../li-application/out/T2_wgs_oristates_unidir_strict_comb.HCCtumor_mcc.tree")
...
ggsave(plot=t1_node_height_comparison_plot,file ="../figures/t1_clocks_height_comparison_plot.png", height = 7, width = 7)
...
ggsave(plot=t2_node_height_comparison_plot,file ="../figures/t2_clocks_height_comparison_plot.png", height = 7, width = 7)
